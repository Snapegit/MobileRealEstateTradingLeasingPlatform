		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="出租价格" prop="chuzujiage">
							<el-input class="list_inp" v-model.number="form.chuzujiage" placeholder="出租价格"
					...
					<el-col :span="24">
						<el-form-item label="出租时间" prop="chuzushijian">
							<el-date-picker
								class="list_date"
								v-model="form.chuzushijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.chuzushijian?true:false"
								placeholder="请选择出租时间" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const zongjia =computed(()=>{
		let c = form.value
		let a = c.chuzujiage*c.zulinyueshu
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.chuzushijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chuzushijian'){
					form.value.chuzushijian = row[x];
					disabledForm.value.chuzushijian = true;
					continue;
				}
				if(x=='zulinyueshu'){
