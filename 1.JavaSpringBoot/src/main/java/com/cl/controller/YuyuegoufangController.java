...
public class YuyuegoufangController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuyuegoufangEntity yuyuegoufang,
		...
		if(tableName.equals("jingjiren")) {
			yuyuegoufang.setJingjirenzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			yuyuegoufang.setYonghuming((String)request.getSession().getAttribute("username"));
		}
